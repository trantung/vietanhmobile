...
class AdminCategoryController extends AdminController {
	...
	public function index()
	{
		...
		return View::make('admin.category.index')->with(compact('inputNewType'));
	}
	...
	public function store()
	{
		...
		if($validator->fails()) {
			return Redirect::action('AdminCategoryController@create')
	...
	{
		return View::make('admin.category.edit')->with(compact('id'));
	}
	...
	public function update($id)
	{
		...
		$validator = Validator::make($input,$rules);
		if($validator->fails()) {
			return Redirect::action('AdminCategoryController@edit', $id)
	            ->withErrors($validator);
        } else {
